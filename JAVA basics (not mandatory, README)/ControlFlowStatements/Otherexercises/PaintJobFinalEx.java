...
public class PaintJobFinalEx {
    ...
    public static int getBucketCount (double width, double height, double areaPerBucket, int extraBuckets){
        ...
        // areaPerBucket = (roomSize / areaPerBucket); 
        // double calculatedBuckets = Math.ceil(areaPerBucket);
        // return (int) calculatedBuckets - extraBuckets;
